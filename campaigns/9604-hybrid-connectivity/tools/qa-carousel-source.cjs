...
const beforeBrandSplit=parse(execFileSync('git',['show','a6cec99:campaigns/9604-hybrid-connectivity/campaign-data.js'],{encoding:'utf8'}));
assert.deepStrictEqual(current,beforeBrandSplit,'The independent branding correction must preserve all existing campaign data.');
...
console.log('PASS: independent branding preserves all campaign data; other channel data unchanged; original carousel engineering notes preserved.');
