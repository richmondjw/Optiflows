...
const requiredFiles = ['index.html', 'styles.css', 'app.js', 'plugins.js', 'README.md', 'fixtures/9604-hybrid-connectivity.json', 'assets/m2m-connectivity-logo.svg', 'assets/m2m-one-logo.png'];
